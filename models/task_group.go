...
func GetTaskGroupList(page, pageSize int) ([]*TaskGroup, int64) {
...
func AddTaskGroup(obj *TaskGroup) (int64, error) {
	if obj.GroupName == "" {
...
func GetTaskGroupById(id int) (*TaskGroup, error) {
	obj := &TaskGroup{
		Id: id,
	}
...
func DelTaskGroupById(id int) error {
